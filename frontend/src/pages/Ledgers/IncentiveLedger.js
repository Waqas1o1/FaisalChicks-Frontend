...
export default function IncentiveLedger() {
        ...
        if (navigator.onLine){
            ...
            .then(res=>{
                ...
                if (data['error'] === true){
                    ...
                    setRows(data);
                    setLoading(false);
                    localStorage.removeItem('IncentiveLedger');
                }
            })
            .catch(error=>{
                setLoading(false);
            ...
            setRows(JSON.parse(localStorage.getItem('IncentiveLedger')));
        }
    }
    ...
    return (
        ...
        >
           {/* Title */}
           <Grid item xs={12} >     
                <Typography variant="h4" gutterBottom  color='primary'>Incentive Ledger</Typography>
            </Grid>
