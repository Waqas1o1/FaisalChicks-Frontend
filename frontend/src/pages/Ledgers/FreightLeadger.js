...
export default function SalesLedger() {
    ...
    async function fetchLedger(){
        if (navigator.onLine){
            return await axiosInstance.get(`apis/FreightLedger/${fields.FromDate}/${fields.ToDate}`)
            .then(res=>{
                let data  = res;
                if (data['error'] === true){
            ...
            setRows(JSON.parse(localStorage.getItem('FreightLedger')));
        }
    }
    ...
    return (
        ...
        >
           {/* Title */}
           <Grid item xs={12} >     
                <Typography variant="h4" gutterBottom  color='primary'>Freight Ledger</Typography>
            </Grid>
